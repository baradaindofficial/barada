  ...
  return (
    <div style={{ fontFamily: 'Inter, system-ui, sans-serif', minHeight: '100vh', background: '#F9FAFB' }}>
      ...
      <div style={{ maxWidth: 800, margin: '4rem auto', padding: '0 2rem' }}>
        <h1 style={{ fontFamily: 'Poppins, system-ui, sans-serif', fontWeight: 800, color: '#0D183D', fontSize: '2rem', marginBottom: '1.5rem' }}>Contact Barada</h1>
        <p style={{ color: '#6B7280', lineHeight: 1.8, fontSize: '1rem' }}>Reach us at info@barada.in or academy@barada.in. We are based in Bengaluru, India.</p>
