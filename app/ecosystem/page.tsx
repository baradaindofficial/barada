...
export const metadata: Metadata = {
  title: 'The Barada Ecosystem | Barada',
}
  ...
  return (
    <div style={{ fontFamily: 'Inter, system-ui, sans-serif', minHeight: '100vh', background: '#F9FAFB' }}>
      ...
      <div style={{ maxWidth: 800, margin: '4rem auto', padding: '0 2rem' }}>
        <h1 style={{ fontFamily: 'Poppins, system-ui, sans-serif', fontWeight: 800, color: '#0D183D', fontSize: '2rem', marginBottom: '1.5rem' }}>The Barada Ecosystem</h1>
        <p style={{ color: '#6B7280', lineHeight: 1.8, fontSize: '1rem' }}>Barada houses four platforms: Barada Academy (AI learning), Partnerschaft (B2B mediation), BKSatpathy.com (founder portfolio), and Ayushman.world (social impact).</p>
