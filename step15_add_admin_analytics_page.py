"""
Creates app/admin/analytics/page.tsx -- the 4 admin-facing widgets:
active learners trend, course popularity, completion rates by course,
estimated certificate revenue. Access already gated by app/admin/layout.tsx.

Run from repo root: py step15_add_admin_analytics_page.py
"""
import os

FILE_PATH = "app/admin/analytics/page.tsx"
